...
- When a session of 3 or more people ends — everyone leaves, or the 2-hour limit hits while people are still in the room — email an HTML table of vote totals (`Tyler` / `4 out of 5 rounds`) to the same address as Pointy feedback. Players named BA are omitted.
